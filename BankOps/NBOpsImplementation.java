...
public class NBOpsImplementation extends UnicastRemoteObject implements BankingOperations, CustomerOperations, Runnable {
    ...
    public NBOpsImplementation() throws Exception {
        super();
    ...
    */
    ...
    public int hashArraylistSize() {
        ...
        //System.out.println("Inside HashARRAYLISTSIZE METHOD " + total);
