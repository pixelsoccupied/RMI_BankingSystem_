 ...
 *
 */
public class MBOpsImplementation extends UnicastRemoteObject implements BankingOperations, CustomerOperations, Runnable {
    ...
    public MBOpsImplementation() throws Exception {
        super();
            ...
            if (newValue.equalsIgnoreCase("QC") || newValue.equalsIgnoreCase("BC") ||
                ...
                if (customerClient != null) {
                    ...
                    try {
                        ...
                        generateLogFileServer(msg, "Server" , "MCServer");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    return true;
   ...
   /* A customer with customerID invokes this method through a CustomerClient. This
    ...
    private synchronized CustomerClient varifiedEntryLookForUser(String customerID) {
