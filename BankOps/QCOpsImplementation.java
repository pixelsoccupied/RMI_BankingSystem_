...
public class QCOpsImplementation extends UnicastRemoteObject implements BankingOperations, CustomerOperations, Runnable {
    ...
    public QCOpsImplementation() throws Exception {
        super();
