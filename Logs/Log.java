...
public class Log {
    ...
    static  public void generateLogFileServer(String msg, String clientType, String clientID) throws SecurityException, IOException {
        ...
        handler = new FileHandler("/Users/Np/Documents/IntellijProjects/Assignment_1_BANKING/src/Log Files/"+clientType+"/"
                    + clientID +".log",true);
    ...
    static  public void generateLogFileClient(String msg, String clientType, String clientID) throws SecurityException, IOException {
        ...
        handler = new FileHandler("/Users/Np/Documents/IntellijProjects/Assignment_1_BANKING/src/Log Files/"+clientType+"/"+ folderServer+"/"
                + clientID +".log",true);
